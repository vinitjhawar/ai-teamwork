...
Real before-and-after transcripts in `examples/` are the most persuasive part of this repo. Anyone shipping a council-reviewed output for real work can contribute one. Use [examples/linkedin-post.md](examples/linkedin-post.md) as the template. Anonymise anything sensitive.
...
- Anything that adds dependencies. Council is intentionally zero-install beyond Claude Code.
