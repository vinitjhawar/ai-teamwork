# How opencouncil works

## The bug opencouncil exists to fix
...
## What opencouncil does instead

Open Council does not ask the model to disagree. It instantiates ten separate role inhabitations, each with its own lens, bias, and explicit veto authority. The model does not have to choose to disagree. The role does it for the model.
