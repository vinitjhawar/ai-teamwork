...
## The bug openteam exists to fix
...
## What openteam does instead

OpenTeam does not ask the model to disagree. It instantiates ten separate role inhabitations, each with its own lens, bias, and explicit veto authority. The model does not have to choose to disagree. The role does it for the model.
